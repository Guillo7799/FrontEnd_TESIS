  ...
  const body = (
    <div style={modalStyle} className={classes.paper}>
      ...
      <p id="simple-modal-description">
        <strong>Nombre de la empresa: </strong> Ingrese el nombre de su
        organización (Ej: Gales Tech).
      </p>
      <p id="simple-modal-description">
      ...
      <p id="simple-modal-description">
        <strong>Correo de contacto: </strong> Ingrese un correo al cual el
        postulante pueda ponerse en contacto.
      </p>
      <p id="simple-modal-description">
